define(['./module'], function (services) {
    'use strict';   
    services.service('forgotpasswordPost', ['$http', '$q', function ($http, $q) {
    	
    	var forgotpasswordPostService = {
    			postForgotPasswordData: function(dataObj) {
    				var deferred = $q.defer();
    				var postObj = dataObj;
    				var urlStr = "api/recover-password";
    		  ...
    		  return forgotpasswordPostService;
    }]);
