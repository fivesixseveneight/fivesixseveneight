define(['./module'], function (services) {
    'use strict';   
    services.service('activationEmailPost', ['$http', '$q', function ($http, $q) {
    	var activationEmailPostService = {
    			postActivateEmailData: function(dataObj) {
    				var deferred = $q.defer();
    				var postObj = dataObj;
    				var urlStr = "api/activate-email";
    		  ...
    		  return activationEmailPostService;
    }]);
