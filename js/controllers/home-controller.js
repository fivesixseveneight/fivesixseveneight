define(['./module'], function (controllers) {
    'use strict';
    controllers.controller('homeController', ['$scope','$rootScope', '$state', 'loginFormPost', function ($scope, $rootScope, $state, loginFormPost) {
    	...
    	//	console.log("home checkIfLoggedIn", $rootScope.isLoggedInBln);
